...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('ctools_collapsible', array('handle' => '<h3 class="ctools-collapsible-title">' . t('District Offices') . '</h3>', 'content' => $offices_content, 'collapsed' => TRUE));
 ?> 
    <?php endif; ?>
...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('ctools_collapsible', array('handle' => '<h3 class="ctools-collapsible-title">' . t('Staff') . '</h3>', 'content' => $staffers_content, 'collapsed' => TRUE));
 ?> 
    <?php endif; ?>
