...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('momentum_officials_social', $social);
 ?>
      <?php endif; ?>
    </div>
  </div>
...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('momentum_officials_committees', $committee);
 ?>
                </li>
                <?php $committee_count++; ?>
              <?php endforeach; ?>
...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('momentum_officials_address', $office);
 ?>
    <?php endif; ?>
...
// 
// @see https://www.drupal.org/node/2195739
// $offices_content .= theme('momentum_officials_address', $office);
 ?>
      <?php endforeach; ?>
      <?php // @FIXME
// theme() has been renamed to _theme() and should NEVER be called directly.
...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('ctools_collapsible', array('handle' => '<h3 class="ctools-collapsible-title">' . t('State Offices') . '</h3>', 'content' => $offices_content, 'collapsed' => TRUE));
 ?> 
    <?php endif; ?>
...
// 
// @see https://www.drupal.org/node/2195739
// $staffers_content .= theme('momentum_officials_staffers', $staffer);
 ?>
      <?php endforeach; ?>
      <?php // @FIXME
// theme() has been renamed to _theme() and should NEVER be called directly.
...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('ctools_collapsible', array('handle' => '<h3 class="ctools-collapsible-title">' . t('Staffers') . '</h3>', 'content' => $staffers_content, 'collapsed' => TRUE));
 ?> 
    <?php endif; ?>
