  ...
  <?php foreach ($officials as $type => $official): ?>
    ...
    <?php if ((!empty($official['official_id'])) && (!empty($official['full_name']))): ?>
      ...
      <div id="official_<?php echo $official['official_id']; ?>">
        ...
        <ul>
          <?php if (!empty($official['photo'])): ?><?php // @FIXME
...
// echo theme('imagecache_external', array('path' => $official['photo'], 'style_name' => 'thumbnail', 'alt' => $official['full_name']));
 ?><?php endif; ?>
          ...
          <?php if (!empty($official['social'])): ?><li><em>Social:</em> <?php // @FIXME
// theme() has been renamed to _theme() and should NEVER be called directly.
// Calling _theme() directly can alter the expected output and potentially
// introduce security issues (see https://www.drupal.org/node/2195739). You
// should use renderable arrays instead.
...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('momentum_officials_social', $official['social']);
 ?></li><?php endif; ?>
          <?php if (!empty($official['office'])): ?><li><em>Office:</em> <?php // @FIXME
// theme() has been renamed to _theme() and should NEVER be called directly.
// Calling _theme() directly can alter the expected output and potentially
// introduce security issues (see https://www.drupal.org/node/2195739). You
// should use renderable arrays instead.
...
// 
// @see https://www.drupal.org/node/2195739
// echo theme('momentum_officials_address', $official['office']);
 ?></li><?php endif; ?>
